...
def run_training(dataset_name_or_id: Union[str, int],
                 ...
                 device: torch.device = torch.device('cuda'),
                 clearml_proj_name: Optional[str] = None,
    ...
    clearml_task = None
    if clearml_proj_name is not None:
        clearml_task = Task.init(project_name=clearml_proj_name, task_name=clearml_task_name)
...
def run_training_entry():
    ...
    parser.add_argument('--clearml_proj_name', type=str, required=False, default=None,
                        help='[OPTIONAL] Specify the name of the ClearML project to be created. Default: None')
    parser.add_argument('--clearml_task_name', type=str, required=False, default=None,
                        help='[OPTIONAL] Specify the name of the ClearML task to be created. Default: None')
    ...
    run_training(args.dataset_name_or_id, args.configuration, args.fold, args.tr, args.p, args.pretrained_weights,
                 ...
                 device=device, clearml_proj_name=args.clearml_proj_name, clearml_task_name=args.clearml_task_name)
